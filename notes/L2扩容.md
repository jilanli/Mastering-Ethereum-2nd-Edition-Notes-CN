...
2. The L1 Validators
  * 作用：通过采样的方式验证Blob中数据的完整性，如果数据正确，确认区块。 

3. The L2 Full Nodes / Indexers
  * 作用：通过gossip network 下载全部的Blob数据，从中生产交易信息。检查sequencer是否作弊，这个是一个Fraud Proofs or ZK-Proofs
