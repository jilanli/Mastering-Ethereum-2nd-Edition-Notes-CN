...
**BLS 签名**是以其作者的名字命名的。**BLS** 代表 Boneh、Lynn 和 Shacham，分别指代三位密码学家 Dan Boneh、Ben Lynn 和 Hovav Shacham。他们在 2001 年发表的一篇名为《基于 Weil 配对的短签名》（[Short Signatures from the Weil Pairing](https://www.iacr.org/archive/asiacrypt2001/22480516.pdf)）的论文中引入了这种签名方案。
